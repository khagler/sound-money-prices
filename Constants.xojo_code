...
Protected Module Constants
	...
	#tag Constant, Name = kDinarInOunces, Type = Double, Dynamic = False, Default = \".1366", Scope = Protected
	#tag EndConstant

	#tag Constant, Name = kDirhamInOunces, Type = Double, Dynamic = False, Default = \"0.095648", Scope = Protected
	#tag EndConstant
